...
class ExperienceEditPipelineViewController: ExperienceEditBaseViewController, UITextFieldDelegate, UITextViewDelegate, UINavigationControllerDelegate, UIPickerViewDelegate, UIPickerViewDataSource
{
	...
	override func viewDidLoad()
	{
        ...
        self.greyscaleField.inputAccessoryView = self.createKeyboardToolBar(target: self, selector: #selector(moveToNextTextField), helpText: "", buttonText: "Next")
		
		thresholdPickerView.dataSource = self
		thresholdPickerView.delegate = self
		self.thresholdField.inputView = thresholdPickerView;
        self.thresholdField.inputAccessoryView = self.createKeyboardToolBar(target: self, selector: #selector(moveToNextTextField), helpText: "", buttonText: "Next")
		
		detectPickerView.dataSource = self
		detectPickerView.delegate = self
		self.detectField.inputView = detectPickerView;
        self.detectField.inputAccessoryView = self.createKeyboardToolBar(target: self, selector: #selector(moveToNextTextField), helpText: "", buttonText: "Done")
